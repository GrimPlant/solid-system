...
def federated_learning_fednova(num_clients=5, rounds=5, epochs=5,
                               batch_size=32, lr=0.03, alpha=0.5):
    ...
    for r in range(rounds):
        ...
        global_state = fednova_aggregate(global_state, updates, steps_list)
...
if __name__ == "__main__":
    set_seed(seed)
    start = time.time()
    federated_learning_fednova(num_clients=5, rounds=5, epochs=10,
                               batch_size=32, lr=0.03, alpha=0.1)
